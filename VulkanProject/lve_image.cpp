...
namespace lve {
    ...
    LveImage::LveImage(LveDevice& device) : lveDevice{device}
    {

    }
    void LveImage::createImage(uint32_t width, uint32_t height, VkFormat format,
    ...
    VkCommandBuffer LveImage::beginSingleTimeCommands()
    {
    ...
    void LveImage::endSingleTimeCommands(VkCommandBuffer commandBuffer)
    {
    ...
    void LveImage::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
    {
    ...
    void LveImage::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
    {
        VkCommandBuffer commandBuffer = beginSingleTimeCommands();
    ...
    void LveImage::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
    {
        VkCommandBuffer commandBuffer = beginSingleTimeCommands();
	...
	void LveImage::createTextureImage()
	{
        ...
        stbi_uc* pixels = stbi_load("images/statue.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    void LveImage::createTextureImageView()
    {
        textureImageView = createImageView(lveDevice, textureImage, VK_FORMAT_R8G8B8A8_SRGB);
    }
    VkImageView LveImage::createImageView(LveDevice &device, VkImage image, VkFormat format)
    {
